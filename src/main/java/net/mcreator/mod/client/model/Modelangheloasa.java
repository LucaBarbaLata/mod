...
public class Modelangheloasa<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mod", "modelangheloasa"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition t = partdefinition.addOrReplaceChild("t",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -23.0F, -8.0F, 16.0F, 18.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(-2, -2).addBox(-6.0F, -21.0F, -11.0F, 12.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition pd = partdefinition.addOrReplaceChild("pd", CubeListBuilder.create().texOffs(28, 34).addBox(-6.0F, -5.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition ps = partdefinition.addOrReplaceChild("ps", CubeListBuilder.create().texOffs(0, 34).addBox(4.0F, -5.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition c = partdefinition.addOrReplaceChild("c", CubeListBuilder.create().texOffs(0, 34).addBox(-5.0F, -29.0F, -7.0F, 9.0F, 6.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition md = partdefinition.addOrReplaceChild("md", CubeListBuilder.create().texOffs(38, 34).addBox(-11.0F, -19.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition ms = partdefinition.addOrReplaceChild("ms", CubeListBuilder.create().texOffs(0, 0).addBox(8.0F, -19.0F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
