...
public class Modelvictor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mod", "modelvictor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ps = partdefinition.addOrReplaceChild("ps", CubeListBuilder.create().texOffs(0, 12).addBox(0.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition pd = partdefinition.addOrReplaceChild("pd", CubeListBuilder.create().texOffs(11, 11).addBox(-2.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition ms = partdefinition.addOrReplaceChild("ms", CubeListBuilder.create().texOffs(9, 6).addBox(1.0F, -4.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition md = partdefinition.addOrReplaceChild("md", CubeListBuilder.create().texOffs(9, 0).addBox(-3.0F, -4.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition t = partdefinition.addOrReplaceChild("t", CubeListBuilder.create().texOffs(0, 6).addBox(-2.0F, -4.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition c = partdefinition.addOrReplaceChild("c", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -7.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
